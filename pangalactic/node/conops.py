...
class ConOpsModeler(QMainWindow):
    ...
    def set_widgets(self, scene=None, current_activity=None, init=False):
        ...
        left_table = ActivityTables(subject=self.subject_activity, parent=self, location='system')
        ...
        right_table = ActivityTables(subject=self.subject_activity, parent=self, location='subsystem')
