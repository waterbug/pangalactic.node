...
# class DraggableListWidget(AutosizingListWidget):
    # def __init__(self, mime_types=None, parent=None):
        # """
        # Initialize.

        # Keyword Args:
            # mime_types (list of str): mime types accepted by the list
        # """
        # super().__init__(parent)
        ...
        # if mime_types:
            # self.accepted_mime_types = set(mime_types)
